package com.gallopmark.imagepicker.widget;
...
public class ClipImageView extends AppCompatImageView {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float left = mCircleCenterX - mTargetWidth / 2f;
        float top =  mCircleCenterY - mTargetHeight / 2f;
        float right = mCircleCenterX + mTargetWidth / 2f;
        float bottom = mCircleCenterY + mTargetHeight / 2f;
        //画入正方形
